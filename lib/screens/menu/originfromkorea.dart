...
class OriginFromKoreaMalatePage extends StatefulWidget {
  final int index;

  OriginFromKoreaMalatePage(this.index);

  @override
  _OriginFromKoreaMalatePageState createState() => _OriginFromKoreaMalatePageState();
}

class _OriginFromKoreaMalatePageState extends State<OriginFromKoreaMalatePage> {
  @override
              ...
              child: Column(
                ...
                children: [
                  ...
                  buildGridView(context, [
                    ...
                    'tongyoungm.png',
                    'premiumblack.png',
                    'liveseacucumberm.png',
                    'mixedseafoodsalad.png',
                    'kodarisaladm.png',
                    'abalonesalad.png',
                    'gwamegi.png',
                    'freshoyster1.png',
                    'freshoyster2.png',
                    'ovenbakedoyster1.png',
                    'ovenbakedoyster2.png',
                  ...
                  buildGridView(context, [
                    'beefspicysoup.png',
                    'seafoodspicysoupm.png',
                    'coldnoodlemealm.png',
                    'coldnoodledessertm.png',
                    'spicycoldnoodlemealm.png',
                    'spicycoldnoodledessertm.png',
                    'sokchocoldnoodlemealm.png',
                    'sokchocoldnoodledessertm.png',
                  ]),
                ],
              ),
            ),
    ...
    return Stack(
      ...
      children: [
        Container(
          ...
          child: ClipRRect(
            borderRadius: BorderRadius.circular(8),
            child: Image.asset('assets/originfromkorea/$imageName', fit: BoxFit.cover),
          ),
        ),
        Positioned(
...
class OriginFromKoreaBGCPage extends StatefulWidget {
  final int index;

  OriginFromKoreaBGCPage(this.index);

  @override
  _OriginFromKoreaBGCPageState createState() => _OriginFromKoreaBGCPageState();
}

class _OriginFromKoreaBGCPageState extends State<OriginFromKoreaBGCPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  buildGridView(context, [
                    'beefspicysoup.png',
                    'seafoodspicysoup.png',
                    'coldnoodlemeal.png',
                    'coldnoodledessert.png',
                    'spicycoldnoodlemeal.png',
                    'spicycoldnoodledessert.png',
                    'sokchocoldnoodlemeal.png',
                    'sokchocoldnoodledessert.png',
                  ]),
                ],
              ),
            ),
...
class OriginFromKoreaPage extends StatefulWidget {
  final int index;

  OriginFromKoreaPage(this.index);

  @override
  _OriginFromKoreaPageState createState() => _OriginFromKoreaPageState();
}

class _OriginFromKoreaPageState extends State<OriginFromKoreaPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
